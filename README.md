...
Documentação inicial de produto e arquitetura para um sistema de agendamento desenvolvido em .NET.

Neste momento, o repositório contém somente documentação. Nenhuma decisão descrita aqui representa código já implementado.
